...
char CTestUSBDlg::ShowPrivateUdisk()
{
	//char gMoveDisk[8] = { 0 };
    //int  iMoveDiskCnt = 0;
	char a = 0;
	...
	for ( drive = 0; drive < 32; ++drive )  
	{
		if ( MaxDriveSet & (1 << drive) )  
		{
			...
			{
					drivetype = DRVREMOVE;
					//gMoveDisk[iMoveDiskCnt++] = szDrvName[0];
					...
					if (hDevice != INVALID_HANDLE_VALUE)
					{
						...
						if(GetDisksProperty(hDevice, pDevDesc))
						{
								...
								name = chFirstDriveFromMask(temp);
								szMoveDiskName[0]=k;
								//k++;
								//ShowMessage("\r\n找到U盘，名称:\r\n");
								p= (char*)pDevDesc;
								...
								//ShowMessage("\r\n产品ID:\r\n");
								str1=(pDevDesc->ProductIdOffset ? &p[pDevDesc->ProductIdOffset]:"(NULL)");
								//ShowMessage(str);
								//ShowMessage("\r\n产品版本:\r\n");
								str2 = (pDevDesc->ProductRevisionOffset ? &p[pDevDesc->ProductRevisionOffset] : "(NULL)");
								//ShowMessage(str);
								//ShowMessage("\r\n序列号:\r\n");
								str3 = (pDevDesc->SerialNumberOffset ? &p[pDevDesc->SerialNumberOffset] : "(NULL)");
								//ShowMessage(str);
								//str.Format("\r\nU盘符:\r\n%c\n",name);
								//ShowMessage(str);
								//if((str=="USB")&&(str1=="Flash DISK")&&(str2=="1100")&&(str3=="1407034090012447"))
								if(str=="HY-Smart")
								{
								    if(str1=="SPI FlashDisk  1")
									{
									    if(str2==".0 ")
										{
										    if(str3=="(NULL)")
...
//	ShowMessage(str);    if((str=="HY-Smart")&&(str1=="SPI FlashDisk  1")&&(str2==".0 ")&&(str3=="(NULL)"))
